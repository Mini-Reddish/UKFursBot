...
public class InviteUserToPrivateChannelCommand(SocketMessageChannelManager socketMessageChannelManager)
    : BaseCommand<InviteUserToPrivateChannelCommandParameters>(socketMessageChannelManager)
{
    ...
    protected override async Task Implementation(SocketSlashCommand socketSlashCommand, InviteUserToPrivateChannelCommandParameters commandParameters)
    {
        ...
        {
            await socketMessageChannelManager.SendLoggingWarningMessageAsync("A user tried to invite someone to a private channel however the channel does not exist.  This suggests that the private channel system is set up invalid.");
        ...
        {
            await socketMessageChannelManager.SendLoggingErrorMessageAsync("Inviting user to private channel failed due to an exception.", httpException);
